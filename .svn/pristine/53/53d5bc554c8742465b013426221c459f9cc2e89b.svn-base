...
{
    logBehavior("log.behavior.page.query", ["commrole.title","commrole.list"]);
    loadRoles();
}
...
function newRole()
{
    logBehavior("log.behavior.dialog.open", ["commrole.list", "new"]);
    ...
    if (!$dlgNewRole)
    {
        ...
        $dlgNewRole.dialog(
        {
            ...
            modal : true,
            cache : true,
            title : $.i18n.prop("commrole.new"),
            width : 400,
            height : 250,
            href : contextPath + "/system/commroles/new",
            buttons : [
            {
                ...
                handler : function()
                {
                    ...
                    {
                        logBehavior("log.behavior.dialog.invaild", ["commrole.new"]);
                        return;
                    }
            ...
            },
            {
                ...
                handler : function()
                {
                    logBehavior("log.behavior.dialog.close", ["commrole.new"]);
                    $dlgNewRole.dialog("close");
                }
            }],
            onOpen : function()
        ...
        {
            logBehavior("log.behavior.dialog.x", ["commrole.new"]);
        });
    }
...
function editRole()
{
    logBehavior("log.behavior.dialog.open", ["commrole.list", "edit"]);
    ...
    if (!$dlgEditRole)
    {
        ...
        $dlgEditRole.dialog(
        {
            ...
            modal : true,
            cache : true,
            title : $.i18n.prop("commrole.edit"),
            width : 400,
            height : 250,
            href : contextPath + "/system/commroles/edit",
            buttons : [
            {
                text : $.i18n.prop("submit"),
                iconCls : "icon-ok",
                handler : function()
                {
                    ...
                    {
                        logBehavior("log.behavior.dialog.invaild", ["commrole.edit"]);
                        return;
                    }
            ...
            },
            {
                ...
                handler : function()
                {
                    logBehavior("log.behavior.dialog.close", ["commrole.edit"]);
                    $dlgEditRole.dialog("close");
                }
            }],
            onOpen : function()
        ...
        {
            logBehavior("log.behavior.dialog.x", ["commrole.edit"]);
        });
    }
...
{
    logBehavior("log.behavior.dialog.open", ["commrole.list", "remove"]);
    
    var messager = $.messager.confirm($.i18n.prop("commrole.remove"), $.i18n.prop("row.confirmDelete"), function(r)
    {
        if (r)
        {
        ...
        {
            logBehavior("log.behavior.dialog.close", ["commrole.remove"]);
        }
    });
    
    $(".panel-tool-close", messager.window("header")).on("click", function()
    {
        logBehavior("log.behavior.dialog.x", ["commrole.remove"]);
    });
}
...
function authorize()
{
    logBehavior("log.behavior.dialog.open", ["commrole.list", "authorization"]);
    ...
    if (!$dlgFun)
    {
        ...
        $dlgFun.dialog(
        {
            ...
            modal : true,
            cache : true,
            title : $.i18n.prop("commrole.authorization"),
            width : 800,
            height : 450,
            ...
            },
            {
                ...
                handler : function()
                {
                    logBehavior("log.behavior.dialog.close", ["commrole.authorization"]);
                    $dlgFun.dialog("close");
                }
            }],
            onOpen : function()
        ...
        {
            logBehavior("log.behavior.dialog.x", ["commrole.authorization"]);
        });
    }
...
{
    logBehavior("log.behavior.dialog.open", ["commrole.list", "commrole.setMembership"]);
    ...
    if (!$dlgSelectUser)
    {
        ...
        $dlgSelectUser.dialog(
        {
            ...
            modal : true,
            cache : true,
            title : $.i18n.prop("commrole.setMembership"),
            width : 940,
            height : 450,
            href : contextPath + "/system/users/select4commrole",
            buttons : [
            {
                text : $.i18n.prop("submit"),
                iconCls : "icon-ok",
            ...
            },
            {
                ...
                handler : function()
                {
                    logBehavior("log.behavior.dialog.close", ["commrole.setMembership"]);
            ...
            onOpen : function()
            {
                ...
                var row = $dgRole.datagrid("getSelections")[0];
                initUserSelector(contextPath + "/system/commroles/" + row.roleId + "/users", null);
            },
            onLoad : function()
            {
                var row = $dgRole.datagrid("getSelections")[0];
        ...
        {
            logBehavior("log.behavior.dialog.x", ["commrole.setMembership"]);
        });
    }
...
function postRoleUser(roleId, rows)
{
    ...
    $.ajax(
    {
        url : contextPath + "/system/commroles/" + roleId + "/users" + "/" + $("#oid").val(),
        type : "post",
        dataType : "json",
        contentType : "application/json",
        data : postData,
