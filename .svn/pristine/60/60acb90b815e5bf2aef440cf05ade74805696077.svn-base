...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
  <form class="form-grid">
    ...
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="form-control" id="parentName" name="parentName" disabled /> 
    ...
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control"  maxlength="16" data-options="required:true,validType:['text','length[1,16]'],novalidate:true" name="orgCode" ></input>
      </div>
      <div class="col-2"></div>
    </div>
    <div class="form-group">
