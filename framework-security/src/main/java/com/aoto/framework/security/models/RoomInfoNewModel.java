...
public class RoomInfoNewModel {
    ...
    public MultipartFile[] getFile1_new() {
        return file1_new;
    }

    public void setFile1_new(MultipartFile[] file1_new) {
        this.file1_new = file1_new;
    }

    public MultipartFile getFile2_new() {
        return file2_new;
    }

    public void setFile2_new(MultipartFile file2_new) {
        this.file2_new = file2_new;
    }

    private MultipartFile[] file1_new;

    private  MultipartFile file2_new;
}
