...
_9e.bb.refresh.linkbutton({iconCls:(_9f.loading?"icon-spinner":"icon-refresh")});
}
};
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {total} items",nav:{first:{iconCls:"icon-step-backward",handler:function(){
var _ae=$(this).pagination("options");
if(_ae.pageNumber>1){
$(this).pagination("select",1);
}
}},prev:{iconCls:"icon-chevron-left",handler:function(){
var _af=$(this).pagination("options");
if(_af.pageNumber>1){
$(this).pagination("select",_af.pageNumber-1);
}
}},next:{iconCls:"icon-chevron-right",handler:function(){
...
var _11b=$(ul).prev().children("span.icon-folder-close");
...
hit.next().addClass("icon-folder-open");
var ul=$(_11f).next();
if(ul.length){
if(opts.animate){
...
hit.next().removeClass("icon-folder-open");
var ul=$(_124).next();
if(opts.animate){
...
_13b.removeClass("icon-leaf").addClass("icon-folder-close icon-folder-open");
...
node.find(".tree-icon").removeClass("icon-folder-close").addClass("icon-leaf");
...
cc.push("<span style=\"color:#ffcc33;\" class=\"tree-icon icon-folder-close "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
if(item.children&&item.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span style=\"color:#ffcc33;\" class=\"tree-icon icon-folder-close icon-folder-open "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span style=\"color:#6699cc;\" class=\"tree-icon icon-leaf "+(item.iconCls?item.iconCls:"")+"\"></span>");
_1a2=true;
}
}
if(opts.checkbox){
...
var _7af=body.find("tr[node-id=\""+_7aa+"\"] span.icon-folder-close");
...
if(_7de.hasClass("icon-leaf")){
_7de.removeClass("icon-leaf").addClass("icon-folder-close icon-folder-open");
...
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
cc.push("<span class=\"tree-icon icon-folder-close "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if(row.children&&row.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"tree-icon icon-folder-close icon-folder-open "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon icon-leaf "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("icon-folder-close").addClass("icon-leaf");
