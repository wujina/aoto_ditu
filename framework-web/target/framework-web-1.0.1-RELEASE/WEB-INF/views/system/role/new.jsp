...
<sec:authentication property="principal" var="currentUser" />
  <form class="form-grid">
    ...
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control" data-options="required:true,novalidate:true" name="orgName" value="${currentUser.orgName}" readonly onclick="selectOrg(this);" /> <input name="orgId" type="hidden" value="${currentUser.orgId}" />
      </div>
      <div class="col-2"></div>
    </div>
    <div class="form-group">
