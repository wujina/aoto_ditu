...
<script src="${staticPath}/static/js/system/role/list.js"></script>
...
<body class="easyui-layout">
  ...
  <div data-options="border:false,region:'center',title:'<fmt:message key="role.list" />',collapsible:true,iconCls:'icon-list'">
    <table data-options="idField:'roleId',pageSize:20,fit:true,fitColumns:true,border:false,rownumbers:true,pagination:true,singleSelect:false,url : '${contextPath}/system/roles/list', method : 'get',queryParams:{roleName:$('#rname').val(),orgId:$('#oid').val(),containSub:$('#containSub').is(':checked')},toolbar:'#tbRole'" id="dgRole">
      <thead>
        <tr>
    ...
    <div id="tbRole" style="padding: 5px;">
      ...
      <c:if test="${currentUser.function['30404']}">
      ...
      <c:if test="${currentUser.function['30405']}">
      ...
      <c:if test="${currentUser.function['30406']}">
