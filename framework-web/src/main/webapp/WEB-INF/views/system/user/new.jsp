 ...
 <form class="form-grid">
    ...
    <div class="form-group">
      <div class="col-3 control-label">
        <label for="username"><fmt:message key="user.username" /><span class="required">*</span> <fmt:message key="colon" /></label>
      </div>
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control" data-options="required:true,validType:['username'],novalidate:true" name="username" />
      </div>
      <div class="col-2"></div>
    </div>
    <div class="form-group">
      <div class="col-3 control-label">
        <label for="realName"><fmt:message key="user.realName" /><span class="required">*</span> <fmt:message key="colon" /></label>
      </div>
      <div class="col-1"></div>
      <div class="col-6">
