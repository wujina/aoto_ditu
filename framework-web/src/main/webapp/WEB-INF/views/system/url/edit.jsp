...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<form class="form-grid">
		<div class="title">
			<fmt:message key="url.edit" />
		</div>
		<div class="form-group">
			<div class="col-3 control-label">
				<label for="urlName"><fmt:message key="url.urlName" /><span
					class="required">*</span> <fmt:message key="colon" />
				</label>
			</div>
			<div class="col-1"></div>
			<div class="col-6">
				<input class="easyui-validatebox form-control" maxlength="32"
					data-options="required:true,validType:['name','length[1,32]'],novalidate:true"
					name="urlName" />
			</div>
			<div class="col-2"></div>
		</div>
		...
		<div class="form-group">
			<div class="col-3 control-label">
				<label for="urlPattern"><fmt:message key="url.urlPattern" /><span
					class="required">*</span> <fmt:message key="colon" />
				</label>
			</div>
			<div class="col-1"></div>
			<div class="col-6">
				<input class="easyui-validatebox form-control" maxlength="32"
					data-options="required:true,validType:['length[1,32]'],novalidate:true"
					name="urlPattern" />
			</div>
			<div class="col-2"></div>
		</div>
		...
		<div class="form-group">
			<div class="col-3 control-label">
				<label for="httpMethod"><fmt:message key="url.httpMethod" /><span
					class="required">*</span> <fmt:message key="colon" />
				</label>
			</div>
			<div class="col-1"></div>
			<div class="col-6">
				<select class="easyui-combobox myeasyui-searchParams"
					id="httpMethod" name="httpMethod" style="width: 185px;"
